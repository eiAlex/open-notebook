export const zhTW = {
  ...
  mcpServers: {
    title: "MCP 伺服器",
    description: "設定模型情境協定伺服器，讓 AI 在聊天時存取外部工具。",
    addServer: "新增伺服器",
    editServer: "編輯伺服器",
    ...
    args: "參數",
    env: "環境變數",
    envHint: "每行一個，格式為 KEY=VALUE",
    headers: "HTTP 標頭",
    headersHint: "每行一個，格式為 KEY=VALUE（例如 Authorization=Bearer my-token）",
    testServer: "測試連線",
    descriptionPlaceholder: "此伺服器的功能...",
    enabledLabel: "已啟用",
    configure: "設定 MCP 伺服器",
    autoUsed: "活躍伺服器將在聊天中自動使用",
    deleteConfirmTitle: "刪除 MCP 伺服器",
    deleteConfirmMessage: "確定要刪除 \"{name}\" 嗎？此操作無法復原。",
    createSuccess: "MCP 伺服器已建立",
    updateSuccess: "MCP 伺服器已更新",
    deleteSuccess: "MCP 伺服器已刪除",
    createError: "建立 MCP 伺服器失敗",
    updateError: "更新 MCP 伺服器失敗",
    deleteError: "刪除 MCP 伺服器失敗",
  },
  setupBanner: {
    encryptionRequired: "未設定加密金鑰",
