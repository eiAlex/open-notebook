export const enUS = {
  ...
  mcpServers: {
    title: "MCP Servers",
    description: "Configure Model Context Protocol servers to give the AI access to external tools during chat.",
    ...
    envHint: "One per line in KEY=VALUE format",
    headers: "HTTP Headers",
    headersHint: "One per line in KEY=VALUE format (e.g. Authorization=Bearer my-token)",
    testServer: "Test connection",
    descriptionPlaceholder: "What this server does...",
    enabledLabel: "Enabled",
    configure: "Configure MCP Servers",
    autoUsed: "Active servers are used automatically in chat",
