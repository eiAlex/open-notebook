export const ptBR = {
  ...
  mcpServers: {
    ...
    description: "Configure servidores do Model Context Protocol para dar à IA acesso a ferramentas externas durante o chat.",
    ...
    envHint: "Uma por linha no formato CHAVE=VALOR",
    headers: "Cabeçalhos HTTP",
    headersHint: "Um por linha no formato CHAVE=VALOR (ex: Authorization=Bearer meu-token)",
    testServer: "Testar conexão",
    descriptionPlaceholder: "O que este servidor faz...",
    enabledLabel: "Habilitado",
    configure: "Configurar Servidores MCP",
    autoUsed: "Servidores ativos são usados automaticamente no chat",
    deleteConfirmTitle: "Excluir Servidor MCP",
    deleteConfirmMessage: "Tem certeza que deseja excluir \"{name}\"? Essa ação não pode ser desfeita.",
    createSuccess: "Servidor MCP criado",
    updateSuccess: "Servidor MCP atualizado",
    deleteSuccess: "Servidor MCP excluído",
    createError: "Falha ao criar servidor MCP",
    updateError: "Falha ao atualizar servidor MCP",
    deleteError: "Falha ao excluir servidor MCP",
  },
  setupBanner: {
    encryptionRequired: "Chave de criptografia não configurada",
