export const jaJP = {
  ...
  mcpServers: {
    title: "MCPサーバー",
    description: "モデルコンテキストプロトコルサーバーを設定して、チャット中にAIが外部ツールにアクセスできるようにします。",
    addServer: "サーバーを追加",
    editServer: "サーバーを編集",
    ...
    args: "引数",
    env: "環境変数",
    envHint: "KEY=VALUE形式で1行に1つ",
    headers: "HTTPヘッダー",
    headersHint: "KEY=VALUE形式で1行に1つ（例: Authorization=Bearer my-token）",
    testServer: "接続テスト",
    descriptionPlaceholder: "このサーバーの機能...",
    enabledLabel: "有効",
    configure: "MCPサーバーを設定",
    autoUsed: "有効なサーバーはチャットで自動的に使用されます",
    deleteConfirmTitle: "MCPサーバーを削除",
    deleteConfirmMessage: "\"{name}\" を削除しますか？この操作は元に戻せません。",
    createSuccess: "MCPサーバーを作成しました",
    updateSuccess: "MCPサーバーを更新しました",
    deleteSuccess: "MCPサーバーを削除しました",
    createError: "MCPサーバーの作成に失敗しました",
    updateError: "MCPサーバーの更新に失敗しました",
    deleteError: "MCPサーバーの削除に失敗しました",
  },
  setupBanner: {
    encryptionRequired: "暗号化キーが設定されていません",
