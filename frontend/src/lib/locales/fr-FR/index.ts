export const frFR = {
  ...
  mcpServers: {
    title: "Serveurs MCP",
    description: "Configurez les serveurs Model Context Protocol pour que l'IA puisse accéder à des outils externes pendant le chat.",
    addServer: "Ajouter un serveur",
    editServer: "Modifier le serveur",
    noServers: "Aucun serveur MCP configuré pour l'instant.",
    enabled: "Activé",
    disabled: "Désactivé",
    transport: "Transport",
    command: "Commande",
    ...
    envHint: "Une par ligne au format KEY=VALUE",
    headers: "En-têtes HTTP",
    headersHint: "Un par ligne au format KEY=VALUE (ex. Authorization=Bearer my-token)",
    testServer: "Tester la connexion",
    descriptionPlaceholder: "Ce que fait ce serveur...",
    enabledLabel: "Activé",
    configure: "Configurer les serveurs MCP",
    autoUsed: "Les serveurs actifs sont utilisés automatiquement dans le chat",
    deleteConfirmTitle: "Supprimer le serveur MCP",
    deleteConfirmMessage: "Êtes-vous sûr de vouloir supprimer \"{name}\" ? Cette action est irréversible.",
    createSuccess: "Serveur MCP créé",
    updateSuccess: "Serveur MCP mis à jour",
    deleteSuccess: "Serveur MCP supprimé",
    createError: "Échec de la création du serveur MCP",
    updateError: "Échec de la mise à jour du serveur MCP",
    deleteError: "Échec de la suppression du serveur MCP",
  },
  setupBanner: {
    encryptionRequired: "Clé de chiffrement non configurée",
