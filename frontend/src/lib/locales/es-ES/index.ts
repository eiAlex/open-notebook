export const esES = {
  ...
  mcpServers: {
    ...
    description: "Configura servidores del Model Context Protocol para que la IA tenga acceso a herramientas externas durante el chat.",
    ...
    envHint: "Una por línea en formato KEY=VALUE",
    headers: "Cabeceras HTTP",
    headersHint: "Una por línea en formato KEY=VALUE (p. ej. Authorization=Bearer my-token)",
    testServer: "Probar conexión",
    descriptionPlaceholder: "Qué hace este servidor...",
    enabledLabel: "Activado",
    configure: "Configurar servidores MCP",
    autoUsed: "Los servidores activos se usan automáticamente en el chat",
    deleteConfirmTitle: "Eliminar servidor MCP",
    deleteConfirmMessage: "¿Estás seguro de que quieres eliminar \"{name}\"? Esta acción no se puede deshacer.",
    createSuccess: "Servidor MCP creado",
    updateSuccess: "Servidor MCP actualizado",
    deleteSuccess: "Servidor MCP eliminado",
    createError: "Error al crear el servidor MCP",
    updateError: "Error al actualizar el servidor MCP",
    deleteError: "Error al eliminar el servidor MCP",
  },
  setupBanner: {
    encryptionRequired: "Clave de encriptación no configurada",
