export const zhCN = {
  ...
  mcpServers: {
    title: "MCP 服务器",
    description: "配置模型上下文协议服务器，让 AI 在聊天时访问外部工具。",
    addServer: "添加服务器",
    editServer: "编辑服务器",
    ...
    args: "参数",
    env: "环境变量",
    envHint: "每行一个，格式为 KEY=VALUE",
    headers: "HTTP 请求头",
    headersHint: "每行一个，格式为 KEY=VALUE（例如 Authorization=Bearer my-token）",
    testServer: "测试连接",
    descriptionPlaceholder: "此服务器的功能...",
    enabledLabel: "已启用",
    configure: "配置 MCP 服务器",
    autoUsed: "活跃服务器将在聊天中自动使用",
    ...
    createError: "创建 MCP 服务器失败",
    updateError: "更新 MCP 服务器失败",
    deleteError: "删除 MCP 服务器失败",
  },
  setupBanner: {
    encryptionRequired: "未配置加密密钥",
