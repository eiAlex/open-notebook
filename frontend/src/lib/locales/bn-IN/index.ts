export const bnIN = {
  ...
  mcpServers: {
    title: "MCP সার্ভার",
    description: "মডেল কনটেক্সট প্রোটোকল সার্ভার কনফিগার করুন যাতে AI চ্যাটের সময় বাহ্যিক টুলে প্রবেশ করতে পারে।",
    addServer: "সার্ভার যোগ করুন",
    editServer: "সার্ভার সম্পাদনা করুন",
    noServers: "এখনও কোন MCP সার্ভার কনফিগার করা হয়নি।",
    enabled: "সক্ষম",
    disabled: "অক্ষম",
    ...
    envHint: "প্রতি লাইনে একটি, KEY=VALUE ফরম্যাটে",
    headers: "HTTP হেডার",
    headersHint: "প্রতি লাইনে একটি, KEY=VALUE ফরম্যাটে (যেমন Authorization=Bearer my-token)",
    testServer: "সংযোগ পরীক্ষা",
    descriptionPlaceholder: "এই সার্ভার কি করে...",
    enabledLabel: "সক্ষম",
    configure: "MCP সার্ভার কনফিগার করুন",
    autoUsed: "সক্রিয় সার্ভারগুলি চ্যাটে স্বয়ংক্রিয়ভাবে ব্যবহৃত হয়",
    deleteConfirmTitle: "MCP সার্ভার মুছে ফেলুন",
    deleteConfirmMessage: "আপনি কি নিশ্চিত \"{name}\" মুছে ফেলতে চান? এটি পুনরায় করা যাবে না।",
    createSuccess: "MCP সার্ভার তৈরি হয়েছে",
    updateSuccess: "MCP সার্ভার আপডেট হয়েছে",
    deleteSuccess: "MCP সার্ভার মুছে ফেলা হয়েছে",
    createError: "MCP সার্ভার তৈরি করতে ব্যর্থ",
    updateError: "MCP সার্ভার আপডেট করতে ব্যর্থ",
    deleteError: "MCP সার্ভার মুছে ফেলতে ব্যর্থ",
  },
  setupBanner: {
    encryptionRequired: "এনক্রিপশন কী কনফিগার করা হয়নি",
