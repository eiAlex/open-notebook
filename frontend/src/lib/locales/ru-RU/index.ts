export const ruRU = {
  ...
  mcpServers: {
    title: "MCP-серверы",
    description: "Настройте серверы Model Context Protocol, чтобы AI мог использовать внешние инструменты в чате.",
    addServer: "Добавить сервер",
    editServer: "Редактировать сервер",
    noServers: "MCP-серверы ещё не настроены.",
    enabled: "Включён",
    disabled: "Отключён",
    transport: "Транспорт",
    command: "Команда",
    ...
    envHint: "По одной в строке в формате KEY=VALUE",
    headers: "HTTP-заголовки",
    headersHint: "По одному в строке в формате KEY=VALUE (например Authorization=Bearer my-token)",
    testServer: "Проверить соединение",
    descriptionPlaceholder: "Что делает этот сервер...",
    enabledLabel: "Включён",
    configure: "Настроить MCP-серверы",
    autoUsed: "Активные серверы используются в чате автоматически",
    deleteConfirmTitle: "Удалить MCP-сервер",
    deleteConfirmMessage: "Вы уверены, что хотите удалить \"{name}\"? Это действие нельзя отменить.",
    createSuccess: "MCP-сервер создан",
    updateSuccess: "MCP-сервер обновлён",
    deleteSuccess: "MCP-сервер удалён",
    createError: "Не удалось создать MCP-сервер",
    updateError: "Не удалось обновить MCP-сервер",
    deleteError: "Не удалось удалить MCP-сервер",
  },
  setupBanner: {
    encryptionRequired: "Ключ шифрования не настроен",
