export const itIT = {
  ...
  mcpServers: {
    title: "Server MCP",
    description: "Configura i server Model Context Protocol per consentire all'IA di accedere a strumenti esterni durante la chat.",
    ...
    envHint: "Una per riga nel formato KEY=VALUE",
    headers: "Intestazioni HTTP",
    headersHint: "Una per riga nel formato KEY=VALUE (es. Authorization=Bearer my-token)",
    testServer: "Testa connessione",
    descriptionPlaceholder: "Cosa fa questo server...",
    enabledLabel: "Abilitato",
    configure: "Configura server MCP",
    autoUsed: "I server attivi vengono usati automaticamente nella chat",
    deleteConfirmTitle: "Elimina server MCP",
    deleteConfirmMessage: "Sei sicuro di voler eliminare \"{name}\"? Questa azione non può essere annullata.",
    createSuccess: "Server MCP creato",
    updateSuccess: "Server MCP aggiornato",
    deleteSuccess: "Server MCP eliminato",
    createError: "Impossibile creare il server MCP",
    updateError: "Impossibile aggiornare il server MCP",
    deleteError: "Impossibile eliminare il server MCP",
  },
  setupBanner: {
    encryptionRequired: "Chiave di crittografia non configurata",
